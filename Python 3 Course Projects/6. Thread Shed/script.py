...
for transaction in daily_transactions_split:
  for i in transaction:
    i = i.strip()
    sub_list.append(i)
  transactions_clean.append(sub_list)
  sub_list = []
...
# Determine the total value of the day sales.
...
# Alternate way using .count method that we learned from the last module about lists.
"""
def color_count(color): 
...
for color in colors:
  ...
  print("Thread Shed sold {} threads of {} thread today.".format(count, color))